...
### Technique (Radial)
- support wrist in slight dorsiflexion
-palpate artery
...
### Dampening
the amount that a pressure wave transmits from the blood and through the tubing to the transducer. [Reference](flightbridgeed.com/index.php/blogs/blogs-view/10-artcles/277-well,-i-ll-be-damped-–-how-square-wave-testing-can-assure-accuracy-in-your-hemodynamic-monitoring-interpretations)
...
#### Square Wave test 
you flush a high pressure wave of saline/heparin through the line, then see how much it reverberates in the line to estimate how easily pressure is transmitted through the system. 
Over-damped = 1 oscillation; perfect = 2 oscillations; under-damped = many. 
