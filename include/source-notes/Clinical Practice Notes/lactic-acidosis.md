...
1. There is no oxygen for oxidative phosphorylation (e.g. ischemic bowel). This is a marker of hypoperfusion. It is [debated](https://www.nejm.org/doi/10.1056/NEJMc1500327) whether this contributes at all to lactate production in sepsis. This is the theory that early goal directed therapy is based on (and has subsequently failed to show benefit when compared to modern care that is targeted toward optimizing this). 
...
The protons come from ATP hydrolysis. Most proper would be a hyperlactatemia and acidosis (or, [sepsis associated lactatemia](https://ccforum.biomedcentral.com/articles/10.1186/s13054-014-0503-3)), but that's a mouthful. However, it's important to realize that the acidosis is correlated with the lactate, but that the lactate is actually working to buffer increased cellular metabolism (ATP hydrolosis). 
...
SEP-1 Federal Mandate: lactate measured within 3 hours in severe sepsis and septic shock. 
(effect of measuing the lactate? or a marker of better care? - there are almost no "tests" that reduce mortality - tests only influence outcomes based on the actions that result from that test).

New sepsis definition: 

Lactate as a marker of physiologic stress and is correlated with severity of sepsis. Over 4-6.5 = bad for mortality. Yes, it's better to have it back to normal ([lactate clearance in 6h is associated with good outcomes](https://journals.lww.com/ccmjournal/Abstract/2004/08000/Early_lactate_clearance_is_associated_with.1.aspx)). But treatments that intervene to directly lower lactate (beta blockers, thiamine), or that seek to decrease lactate in the method not present (e.g. decreased perfusion - would expect blood transfusions to increase) have not been shown to help. It is a confounder to the real issue. 
...
Lactic acidosis can occur with any VO2/DO2 aka ScVO2 due to mal-distribution of blood flow.
...
Answer: early vasopressors correct faster, as in the [CENSER trial](https://pubmed.ncbi.nlm.nih.gov/30704260/) of early vasopressors vs fluids. 
