...
Answer: Imagine a respiratory system that is stressed (ie. requiring compensation) by a severe metabolic acidosis (e.g. DKA) but is unable to rise and meet the demand. [More here](https://www.atsjournals.org/doi/full/10.1513/AnnalsATS.201305-132OT)
...
**How do you get information on the amount of deadspace?**
The deadspace fraction 
...
**What limits our up-titration of each of the major parameters?**
RR 
TIdal Volume (Vt) 
FiO2
PEEP
...
Note: mechanical ventilation does not fix any disease process. It only supports the lungs (and respiratory system) until they heal themselves. 
Thus, our MAJOR goal is to avoid doing damage to the lungs. 
...
How do we measure pressure in the lungs? Separate dynamic pressure (from resistance to flow through the airways) and static pressure (pressure in the lungs when there is no flow). 
