...
Diagnostic reasoning: diagnose the problem
Reasoning process: 
...
## [Make it stick notes](https://www.amazon.com/Make-Stick-Science-Successful-Learning/dp/0674729013)
...
- 'Familiarity Trap' = feeling that you know something so that it no longer needs to be retrieved
-Block practice (e.g. running the same drill over and over) feels easier, which is why it doesn't work as well (despite seeming like it does). Cards must be in random order
...
### Ch 6
- High structure builders (ie find patterns in the learning and insert content into that structure) learn better - e.g. determining rules instead of memorizing examples.  Comparing/contrasting different examples
-Reflection may encourage structure building.
...
![alt](https://photos.collectednotes.com/photos/5187/7a1be875-30cf-4bcf-86e7-8cbaa2d0bf57)
Source: DOI: 10.34197/ats-scholar.2020-0157ED
